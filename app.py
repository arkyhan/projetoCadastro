...
restaurantes = [{'nome': 'Willz Burguer', 'categoria': 'Hambuergueria', 'ativo': False},
                {'nome': 'Uluru','categoria': 'cafeteria', 'ativo': True}, 
                {'nome': 'Dominos','categoria': 'Pizzaria','ativo': True}]
